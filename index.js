...
if (ques1.toLowerCase = firstQuesAns){
...
if (ques2.toLowerCase = secondQuesAns){
    document.writeln("Congratulation!!!");
}else{
...
if (ques3.toString = thirdQuesAns){
    document.writeln("Congratulation!!!");
}else{
...
if (ques4.toLowerCase = fourthQuesAns){
    document.writeln("Congratulation!!!");
}else{
...
if (ques5.toLowerCase = fifthQuesAns){
    document.writeln("Congratulation!!!");
}else{
